...
public static class CarList
{
    ...
    public static Car CarOffroad = new Car(CarName.Offroad, 650, 2.99f, true, "car_offroad");
    public static Car CarKart = new Car(CarName.Kart, 1000, 4.99f, true, "car_kart");
    public static List<Car> List = new List<Car>() {CarSedan, CarTruck, CarOffroad, CarKart};
