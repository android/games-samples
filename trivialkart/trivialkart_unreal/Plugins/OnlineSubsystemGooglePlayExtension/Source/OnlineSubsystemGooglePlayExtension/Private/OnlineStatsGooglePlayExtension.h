...
/**
 * Implementation of Online Stats Interface to viewing PGS Player Stats
 */
class FOnlineStatsGooglePlayExtension : public IOnlineStats
{
public:
	FOnlineStatsGooglePlayExtension(FOnlineSubsystemGooglePlayExtension* InSubsystem);
...
#endif
	void CacheQueryResults(const FUniqueNetIdRef& StatsUserId, const TSharedRef<const FOnlineStatsUserStats>& InStats);
	// --- IOnlineStats Interface Ends---

private:
	FOnlineSubsystemGooglePlayExtension* Subsystem;
    
	// Cache of queried stats
	TMap<FUniqueNetIdRef, TSharedRef<const FOnlineStatsUserStats>> StatsCache;
};
