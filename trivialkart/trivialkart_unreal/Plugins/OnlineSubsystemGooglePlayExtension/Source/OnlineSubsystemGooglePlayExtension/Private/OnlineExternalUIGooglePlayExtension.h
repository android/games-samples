...
/**
 * Implementation of Online External UI Interface to viewing PGS friends Profile feature
 */
class FOnlineExternalUIGooglePlayExtension : public IOnlineExternalUI
{
public:
	FOnlineExternalUIGooglePlayExtension(FOnlineSubsystemGooglePlayExtension* InSubsystem, const IOnlineExternalUIPtr& InExternalUI);
...
private:
	...
	IOnlineExternalUIPtr BaseExternalUI;
};
